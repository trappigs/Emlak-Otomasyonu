...
Public Class ArsaListesi
    Private Sub ArsaListesi_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ada_no_KeyPress(sender As Object, e As KeyPressEventArgs) Handles ada_no.KeyPress
    ...
    Private Sub parsel_no_KeyPress(sender As Object, e As KeyPressEventArgs) Handles parsel_no.KeyPress
        If Not Char.IsDigit(e.KeyChar) AndAlso Not Char.IsControl(e.KeyChar) Then
            ' Girilen karakter bir sayı değilse ve kontrol karakteri de değilse
            ' Tuş vuruşunu reddetmek için Handle özelliğini true olarak ayarla
            e.Handled = True
    ...
    Private Sub imar_cesidi_KeyPress(sender As Object, e As KeyPressEventArgs) Handles imar_cesidi.KeyPress
    ...
    Private Sub kaks_degeri_KeyPress(sender As Object, e As KeyPressEventArgs) Handles kaks_degeri.KeyPress
        If Not Char.IsDigit(e.KeyChar) AndAlso Not Char.IsControl(e.KeyChar) Then
            ' Girilen karakter bir sayı değilse ve kontrol karakteri de değilse
            ' Tuş vuruşunu reddetmek için Handle özelliğini true olarak ayarla
            e.Handled = True
        ...
        If kaks_degeri.Text.Length >= 6 AndAlso Not Char.IsControl(e.KeyChar) Then
            e.Handled = True
        End If
    End Sub

    Private Sub gabari_degeri_KeyPress(sender As Object, e As KeyPressEventArgs) Handles gabari_degeri.KeyPress
        If Not Char.IsDigit(e.KeyChar) AndAlso Not Char.IsControl(e.KeyChar) Then
            ' Girilen karakter bir sayı değilse ve kontrol karakteri de değilse
            ' Tuş vuruşunu reddetmek için Handle özelliğini true olarak ayarla
            e.Handled = True
        ...
        If gabari_degeri.Text.Length >= 6 AndAlso Not Char.IsControl(e.KeyChar) Then
            e.Handled = True
        End If
    End Sub

    Private Sub tapu_durumu_KeyPress(sender As Object, e As KeyPressEventArgs) Handles tapu_durumu.KeyPress
        If Not Char.IsLetter(e.KeyChar) AndAlso Not Char.IsControl(e.KeyChar) Then
            ' Diğer tuş vuruşlarını engelle
            e.Handled = True
        End If

        If tapu_durumu.Text.Length >= 250 AndAlso Not Char.IsControl(e.KeyChar) Then
            e.Handled = True
        End If
    End Sub
    ...
    Private Sub il_adi_KeyPress(sender As Object, e As KeyPressEventArgs) Handles il_adi.KeyPress
        ...
        If il_adi.Text.Length >= 250 AndAlso Not Char.IsControl(e.KeyChar) Then
            e.Handled = True
        End If
    End Sub
    ...
    Private Sub ilce_adi_KeyPress(sender As Object, e As KeyPressEventArgs) Handles ilce_adi.KeyPress
        ...
        If ilce_adi.Text.Length >= 250 AndAlso Not Char.IsControl(e.KeyChar) Then
            e.Handled = True
        End If
    End Sub
    ...
    Private Sub mahalle_adi_KeyPress(sender As Object, e As KeyPressEventArgs) Handles mahalle_adi.KeyPress
        ...
        If mahalle_adi.Text.Length >= 250 AndAlso Not Char.IsControl(e.KeyChar) Then
            e.Handled = True
        End If
    End Sub

    Private Sub emlak_sahibi_tc_KeyPress(sender As Object, e As KeyPressEventArgs) Handles emlak_sahibi_tc.KeyPress
        If Not Char.IsControl(e.KeyChar) Then
            ' Tuş vuruşlarını engelle
            e.Handled = True
        End If
    End Sub

    Private Sub AlanBuyuk_KeyPress(sender As Object, e As KeyPressEventArgs) Handles AlanBuyuk.KeyPress
        If Not Char.IsDigit(e.KeyChar) AndAlso Not Char.IsControl(e.KeyChar) Then
            ' Girilen karakter bir sayı değilse ve kontrol karakteri de değilse
            ' Tuş vuruşunu reddetmek için Handle özelliğini true olarak ayarla
            e.Handled = True
